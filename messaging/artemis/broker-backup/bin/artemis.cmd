...
rem Use the instance-local etc dir (default set above to %~dp0..). This avoids
rem accidentally pinning to an old demo path and loading the wrong broker.xml.
set ARTEMIS_INSTANCE_ETC=%ARTEMIS_INSTANCE%\etc
