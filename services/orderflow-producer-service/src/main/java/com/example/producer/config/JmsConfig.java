  ...
  public ServerLocator serverLocator() throws Exception {
    ...
    locator.addClusterTopologyListener(new ClusterTopologyListener() {
      ...
      @Override public void nodeUP(TopologyMember m, boolean last) {
        log.info("NODE UP  primary={} backup={} id={}",
            fmt(m.getPrimary()), fmt(m.getBackup()), m.getNodeId());
      }
      @Override public void nodeDown(long uid, String nodeId) {
        log.warn("NODE DOWN id={}", nodeId);
      }
